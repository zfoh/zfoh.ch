...
(function($PS) {
  ...
  var scheduleStart = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 42, column 1 - line 42, column 53): " + [ v.constructor.name ]);
  };
  var scheduleParallelism = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 52, column 1 - line 52, column 51): " + [ v.constructor.name ]);
  };
  var scheduleEnd = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 47, column 1 - line 47, column 51): " + [ v.constructor.name ]);
  };
  var scheduleInsert = function (entry) {
      return function (schedule) {
          ...
          if (Data_Boolean.otherwise) {
              ...
              throw new Error("Failed pattern match at Main (line 65, column 19 - line 78, column 59): " + [ schedule.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 59, column 1 - line 59, column 64): " + [ entry.constructor.name, schedule.constructor.name ]);
      };
  };
      ...
      return function (day) {
              ...
              return function (zero) {
                  return function (left) {
                      return function (width) {
                          return function (schedule) {
                              if (schedule instanceof Single) {
                                  var y = (ticks(schedule.value0.start) - ticks(zero)) + Data_Int.toNumber(20);
                                  var height = ticks(schedule.value0.end) - ticks(schedule.value0.start);
                                  return function __do() {
                                      var div = Web_DOM_Document.createElement("div")(doc)();
                                      Web_DOM_Element.setAttribute("class")("entry")(div)();
                                      Web_DOM_Element.setAttribute("style")("position: absolute;" + ("top: " + (Data_Show.show(Data_Show.showNumber)(y) + ("px;" + ("left: " + (Data_Show.show(Data_Show.showInt)(left) + ("%; " + ("width: " + (Data_Show.show(Data_Show.showInt)(width) + ("%; " + ("height: " + (Data_Show.show(Data_Show.showNumber)(height) + "px;"))))))))))))(div)();
                                      var startStr = $foreign.renderDateTime(schedule.value0.start)();
                                      var endStr = $foreign.renderDateTime(schedule.value0.end)();
                                      Web_DOM_Node.setTextContent(startStr + (" - " + (endStr + (": " + schedule.value0.content))))(Web_DOM_Element.toNode(div))();
                                      return Web_DOM_Node.appendChild(Web_DOM_Element.toNode(div))(Web_DOM_Element.toNode(container))();
                                  };
                              };
                              if (schedule instanceof After) {
                                  return function __do() {
                                      go(container)(zero)(left)(width)(schedule.value0)();
                                      return go(container)(zero)(left)(width)(schedule.value1)();
                                  };
                              };
                              if (schedule instanceof Parallel) {
                                  var yp = scheduleParallelism(schedule.value1);
                                  var xp = scheduleParallelism(schedule.value0);
                                  var unitWidth = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(width)(xp + yp | 0);
                                  return function __do() {
                                      go(container)(zero)(left)(xp * unitWidth | 0)(schedule.value0)();
                                      return go(container)(zero)(left + (xp * unitWidth | 0) | 0)(yp * unitWidth | 0)(schedule.value1)();
                                  };
                              };
                              throw new Error("Failed pattern match at Main (line 102, column 45 - line 130, column 73): " + [ schedule.constructor.name ]);
                          };
                      };
                  };
              };
          ...
          return function (schedule) {
              return function __do() {
                  ...
                  var start = ticks(scheduleStart(schedule));
                  var end = ticks(scheduleEnd(schedule));
                  var height = (end - start) + Data_Int.toNumber(20);
  ...
  var parseEntry = function (element) {
      return function __do() {
          var tds = Control_Bind.bind(Effect.bindEffect)(Web_DOM_ParentNode.querySelectorAll("td")(Web_DOM_Element.toParentNode(element)))(Web_DOM_NodeList.toArray)();
          var v = Data_Functor.map(Data_Functor.functorArray)(Web_HTML_HTMLElement.fromNode)(tds);
          if (v.length === 3 && (v[0] instanceof Data_Maybe.Just && (v[1] instanceof Data_Maybe.Just && v[2] instanceof Data_Maybe.Just))) {
              var startText = $foreign.innerText(v[0].value0)();
              var start = Data_JSDate.parse(startText)();
              var endText = $foreign.innerText(v[1].value0)();
              var end = Data_JSDate.parse(endText)();
              var content = $foreign.innerText(v[2].value0)();
  ...
  var calendarRender = function (doc) {
      return function (calendar) {
          return Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Tuple.uncurry(scheduleRender(doc)))(Data_Array.sortWith(Data_JSDate.ordJSDate)(function ($50) {
              return scheduleStart(Data_Tuple.snd($50));
  ...
  var calendarInsert = function (entry) {
      return function (calendar) {
          ...
          throw new Error("Failed pattern match at Main (line 140, column 33 - line 142, column 72): " + [ v.constructor.name ]);
      };
  };
  ...
  var main = function __do() {
      ...
      var entries = parseEntries(schedule)();
      var calendar = calendarFromEntries(entries);
      Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_DOM_ParentNode.children(Web_DOM_Element.toParentNode(schedule)))(Web_DOM_HTMLCollection.toArray))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function ($51) {
          return Web_DOM_ChildNode.remove(Web_DOM_Element.toChildNode($51));
      }))();
