...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.a7, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aQ: 'hidden', aJ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aQ: 'mozHidden', aJ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aQ: 'msHidden', aJ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aQ: 'webkitHidden', aJ: 'webkitvisibilitychange' }
		: { aQ: 'hidden', aJ: 'visibilitychange' };
}
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, aI: r.aI, aN: r.aN, e: r.e, h: r.h, i: r.i, j: r.j, a7: r.a7}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{aI: elm$http$Http$emptyBody, aN: r.aN, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, a7: r.a7});
};
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Main$readProjects = elm$http$Http$get(
	{
		aN: A2(
...
var billstclair$elm_sortable_table$Table$HtmlDetails = F2(
	function (attributes, children) {
		return {E: attributes, F: children};
	});
...
var billstclair$elm_sortable_table$Table$defaultCustomizations = {U: elm$core$Maybe$Nothing, aY: billstclair$elm_sortable_table$Table$simpleRowAttrs, a1: _List_Nil, aa: _List_Nil, ab: elm$core$Maybe$Nothing, a2: billstclair$elm_sortable_table$Table$simpleThead};
	...
	return billstclair$elm_sortable_table$Table$customConfig(
		{
			...
			aL: _Utils_update(
				...
				{
					aY: author$project$Main$toRowAttrs(selectedIds),
					a1: _List_fromArray(
						[
...
var billstclair$elm_sortable_table$Table$viewCell = F2(
	function (data, _n0) {
		...
		return A2(elm$html$Html$td, details.E, details.F);
	});
...
var billstclair$elm_sortable_table$Table$view = F3(
	function (conf, state, data) {
		...
		var toMsg = conf.a5;
		var columns = conf.aK;
		var customizations = conf.aL;
		var theadDetails = customizations.a2(
			A2(
				elm$core$List$map,
		...
		var tbody = A3(
			...
			A2(
				elm$core$List$map,
				A3(billstclair$elm_sortable_table$Table$viewRow, toId, columns, customizations.aY),
				sortedData));
		var withFoot = function () {
			var _n1 = customizations.ab;
			if (_n1.$ === 1) {
				return A2(elm$core$List$cons, tbody, _List_Nil);
			} else {
				var attributes = _n1.a.E;
				var children = _n1.a.F;
				return A2(
					elm$core$List$cons,
		...
		return A2(
			...
			customizations.a1,
			function () {
				var _n0 = customizations.U;
				if (_n0.$ === 1) {
					return A2(elm$core$List$cons, thead, withFoot);
				} else {
					var attributes = _n0.a.E;
					var children = _n0.a.F;
					return A2(
						elm$core$List$cons,
